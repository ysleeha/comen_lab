...
HD_PWD='C:/comen_lab/practice_1/practice_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_8.tcl
