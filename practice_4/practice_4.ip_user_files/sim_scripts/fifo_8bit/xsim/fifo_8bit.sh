...
#
# Generated by Vivado on Fri Feb 02 07:15:00 +0900 2024
# SW Build 3788238 on Tue Feb 21 20:00:34 MST 2023
#
# Tool Version Limit: 2022.10 
#
# usage: fifo_8bit.sh [-help]
# usage: fifo_8bit.sh [-lib_map_path]
# usage: fifo_8bit.sh [-noclean_files]
# usage: fifo_8bit.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "fifo_8bit.sh - Script generated by export_simulation (Vivado v2022.2.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L fifo_generator_v13_2_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_8bit xil_defaultlib.fifo_8bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  fifo_8bit -key {Behavioral:sim_1:Functional:fifo_8bit} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_8bit.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_8bit.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fifo_8bit.sh -help\" for more information)\n"
    exit 1
  fi
