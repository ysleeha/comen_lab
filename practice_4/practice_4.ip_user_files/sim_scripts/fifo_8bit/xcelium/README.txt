...
#
# Generated by export_simulation on Fri Feb 02 07:15:00 +0900 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_8bit.sh' script.

./fifo_8bit.sh -reset_run
...
./fifo_8bit.sh -noclean_files

For more information on the script, please type './fifo_8bit.sh -help'.
