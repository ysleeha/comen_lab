...
REM
REM Generated by Vivado on Sun Feb 04 06:04:48 +0900 2024
...
echo "xvlog --incr --relax -L uvm -prj tb_uart_receiv_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_uart_receiv_vlog.prj -log xvlog.log
