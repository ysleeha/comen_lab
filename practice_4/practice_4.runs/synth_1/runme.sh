...
HD_PWD='C:/comen_lab/practice_4/practice_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_receiv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_receiv.tcl
