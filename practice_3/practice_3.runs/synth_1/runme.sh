...
HD_PWD='C:/comen_lab/practice_3/practice_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_rx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_rx.tcl
