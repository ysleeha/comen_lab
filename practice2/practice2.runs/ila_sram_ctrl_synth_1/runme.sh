...
HD_PWD='C:/comen_lab/practice2/practice2.runs/ila_sram_ctrl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_sram_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_sram_ctrl.tcl
