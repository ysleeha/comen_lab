...
#
# Script generated by Vivado on Sun Jan 14 03:59:42 +0900 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : mmcm_50m.sh
...
#
# Usage        : mmcm_50m.sh
#                mmcm_50m.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mmcm_50m.sh [-reset_run]
#                mmcm_50m.sh [-reset_log]
#                mmcm_50m.sh [-help]
#
...
# script info
echo -e "mmcm_50m.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mmcm_50m.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mmcm_50m xil_defaultlib.mmcm_50m xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mmcm_50m -key {Behavioral:sim_1:Functional:mmcm_50m} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mmcm_50m.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mmcm_50m.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mmcm_50m.sh [-help]\n\
Usage: mmcm_50m.sh [-step]\n\
Usage: mmcm_50m.sh [-lib_map_path]\n\
Usage: mmcm_50m.sh [-reset_run]\n\
Usage: mmcm_50m.sh [-reset_log]\n\
Usage: mmcm_50m.sh [-keep_index]\n\
Usage: mmcm_50m.sh [-noclean_files]\n\n\
