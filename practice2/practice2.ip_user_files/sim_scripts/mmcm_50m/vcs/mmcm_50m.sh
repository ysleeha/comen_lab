...
#                script (type 'mmcm_50m.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mmcm_50m xil_defaultlib.glbl -o mmcm_50m_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mmcm_50m_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mmcm_50m_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mmcm_50m_simv.daidir vcs_lib c.obj)
