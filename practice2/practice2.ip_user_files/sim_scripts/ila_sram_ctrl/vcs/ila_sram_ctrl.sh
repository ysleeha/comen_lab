...
#
# Script generated by Vivado on Sun Jan 14 02:09:02 +0900 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ila_sram_ctrl.sh
...
#
# Usage        : ila_sram_ctrl.sh
#                ila_sram_ctrl.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_sram_ctrl.sh [-reset_run]
#                ila_sram_ctrl.sh [-reset_log]
#                ila_sram_ctrl.sh [-help]
#
...
#                script (type 'ila_sram_ctrl.sh -help' for more information).
#
...
# script info
echo -e "ila_sram_ctrl.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_sram_ctrl.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../practice2.gen/sources_1/ip/ila_sram_ctrl/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../practice2.gen/sources_1/ip/ila_sram_ctrl/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_sram_ctrl xil_defaultlib.glbl -o ila_sram_ctrl_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_sram_ctrl_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_sram_ctrl_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_sram_ctrl_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_sram_ctrl.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_sram_ctrl.sh [-help]\n\
Usage: ila_sram_ctrl.sh [-step]\n\
Usage: ila_sram_ctrl.sh [-lib_map_path]\n\
Usage: ila_sram_ctrl.sh [-reset_run]\n\
Usage: ila_sram_ctrl.sh [-reset_log]\n\
Usage: ila_sram_ctrl.sh [-keep_index]\n\
Usage: ila_sram_ctrl.sh [-noclean_files]\n\n\
