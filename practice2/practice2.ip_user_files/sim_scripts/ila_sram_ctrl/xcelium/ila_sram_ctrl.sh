...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../practice2.gen/sources_1/ip/ila_sram_ctrl/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../practice2.gen/sources_1/ip/ila_sram_ctrl/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_sram_ctrl xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_sram_ctrl -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_sram_ctrl_sc.so .tmp_log xcelium_lib waves.shm c.obj)
